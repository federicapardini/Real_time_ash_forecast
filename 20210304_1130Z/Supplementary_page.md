...
Supplementary for: Forecast from VONA bulletin - 20210304_1130Z
===============================================================
...
|Column height|11000 ± 1000 - from VONA|Gaussian|
|Total Grain Size Distribution|μ = 2.3 ± 0.5 φ,  σ = 1.5 ± 0.5 φ|Gaussian|
|Number of ensemble members per scenario|100||
  
Go to [Main page](https://github.com/federicapardini/Real_time_ash_forecast/tree/main/20210304_1130Z)  
