...
Supplementary for: Forecast from VONA bulletin - 20210228_1047Z
===============================================================
...
|Column height|Uniform [6000 m, 12000 m]|
|Total Grain Size Distribution|Gaussian μ = 2.3 ± 0.5 φ,  σ = 1.5 ± 0.5 φ|
|Number of ensemble members per scenario|100|
  
Go to [Main page](https://github.com/federicapardini/Real_time_ash_forecast/tree/main/20210228_1047Z)  
