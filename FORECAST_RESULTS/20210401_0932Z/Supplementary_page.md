...
Supplementary for: Forecast from VONA bulletin - 20210401_0932Z
===============================================================
...
|Column height|5500 ± 500 - from VONA|Gaussian|
|Total Grain Size Distribution|μ = [-3 φ, 2 φ], σ = [0.6 φ, 1.5 φ]|Uniform|
|Number of ensemble members per scenario|50||
  
Go to [Main page](https://github.com/federicapardini/Real_time_ash_forecast/tree/main/FORECAST_RESULTS/20210401_0932Z)  
