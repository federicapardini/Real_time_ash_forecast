...
Supplementary for: Forecast from VONA bulletin - 20210314_2236Z
===============================================================
...
|Column height|8000.0 ± 500 - from VONA|Gaussian|
|Total Grain Size Distribution|μ = [-3 φ, 2 φ], σ = [0.6 φ, 1.5 φ]|Uniform|
|Number of ensemble members per scenario|9||
  
Go to [Main page](https://github.com/federicapardini/Real_time_ash_forecast/FORECAST_RESULTS/tree/main/20210314_2236Z)  
