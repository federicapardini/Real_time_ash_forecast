...
Supplementary for: Forecast from VONA bulletin - 20210303_1702Z
===============================================================
...
|Parameters|Values|Type of ditribution|
| :--- | :--- | :--- |
...
|Column height|6000 ± 1000 - from VONA|Gaussian|
|Total Grain Size Distribution|Gaussian μ = 2.3 ± 0.5 φ,  σ = 1.5 ± 0.5 φ|Gaussian|
|Number of ensemble members per scenario|9||
  
Go to [Main page](https://github.com/federicapardini/Real_time_ash_forecast/tree/main/20210303_1702Z)  
